...
Write-heavy persistent workloads need enough data region memory, checkpoint buffer space, WAL capacity, partition-file capacity, and OS page cache headroom.
...
If a region reaches its limit, cache operations can fail.
